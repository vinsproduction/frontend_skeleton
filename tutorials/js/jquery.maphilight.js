(function($) {
	...
	$.fn.maphilight = function(opts) {
		...
		return this.each(function() {
			...
			var bg;
			if (browser.msie) {
		      bg = "filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + this.src + "',sizingMethod='scale');-ms-filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + this.src + "',sizingMethod='scale')";
		   } else {
		      bg = "background: url(" + this.src + ");background-size: 100%;";
		   }

			wrap = $('<div></div>')
			.attr('style', "display:block;position:relative;padding:0;width:"+this.width+"px;height:"+this.height+"px;" + bg)
